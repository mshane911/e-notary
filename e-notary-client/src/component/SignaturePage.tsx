...
export default function SignaturePage(){
    ...
    async function generateSignature() {
        ...
        const data = {
            ...
            "token": myToken,
            "fileType": "URL",
            //"filePath": `/pdf/signDocuments/${userId}/${userId}.pdf`,
            ...
            "signList": [
                {
                    ...
                    "stampWidth": "120",
                    "stampHeight": "40",
                    "reason": "i like to eat paper", // set by user
                    "reasonCaption": "Reason",
                    "location": "myLocation", // set by user
                    "locationCaption": "Location"
                },
                {
                    "signType": "Digital",
                    "signOption": "Stamp",
                    "signPage": "1", // set by user
                    "stampType": "URL",
                    //"stampPath": `/pdf/signImages/${userId}/${userId}.png`,
                    "stampPath": "https://www.cellmark.com/wp-content/uploads/2017/03/signature_anniehe.png",
                    "stampX": "70", // set by user
                    "stampY": "698", // set by user
                    "stampWidth": "60",
                    "stampHeight": "60",
                }
            ]
    ...
    function Dashboard() {
        if (!user) {
            ...
            <div className='dashboard'>
                ...
                <h3 className='sectionSubtitle'>User name: {user.name} {user._id}</h3>
